...
class SendRequest:
    ...
    def send_request(self, **kwargs):
        ...
        try:
            ...
            # if set_cookie:
            #     cookie['Cookie'] = set_cookie  # {'Cookie': {'access_token_cookie': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..ho8XtzHYrdB6zvQONoCvUmWbLuprKzjlzcSw1uYELrw', 'csrf_access_token': '5568af81-4f6d-458a-8d21-e4483642a4ef'}}
    ...
    def run_main(self, name, url, case_name, header, method, cookies=None, file=None, **kwargs):
        ...
        try:
            ...
            req_params = json.dumps(kwargs, ensure_ascii=False) # '{"data": {"user_name": "test01", "passwd": "admin123"}}'
